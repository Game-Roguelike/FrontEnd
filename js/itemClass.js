...
export class Equipment {
    constructor(name, spriteImage, type, hp, strength, endurance, damageBonus, damageResist, price) {
        this.name = name;
        this.spriteImage = "http://localhost:8080/game/image?path=" + spriteImage;
        this.fallbackImage = "./assets/Fallback/testChestplate.png";
        this.type = type;
        this.price = price;
...
export class Weapon {
    constructor(name, spriteImage, damage, strength, price, hp, damageBonus) {
        this.name = name;
        this.spriteImage = "http://localhost:8080/game/image?path=" + spriteImage;
        this.fallbackImage = "./assets/Fallback/testWeapon.png";
        this.price = price;
...
export class Usable {
    constructor(name, spriteImage, price, target, hp, uses) {
        this.name = name;
        this.spriteImage = "http://localhost:8080/game/image?path=" + spriteImage;
        this.fallbackImage = "./assets/Fallback/testUsable.png";
        this.price = price;
